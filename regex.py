...
"""
Per te punuar me regex importojm librarine e regex e quajtur 're'

re.search eshte njesoj si funksioni find()--> per string
re.findall()--> gjen te gjithe string qe perputhen me regex... kete e ben pasi ndane string ne stringje me te vegjel
njesoj si slicing []
"""
